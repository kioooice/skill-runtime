...
def matches(trajectory: Trajectory, input_schema: dict[str, str]) -> bool:
    ...
    required_inputs = {"input_dir", "suffix"}
    return (
...
def explain_match(trajectory: Trajectory, input_schema: dict[str, str]) -> str:
    return "Matched batch_rename_suffix because the trajectory lists files, renames paths, and provides input_dir/suffix inputs."

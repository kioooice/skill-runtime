...
- Search quality baseline: `python scripts/evaluate_search_quality.py`; this checks current active skills against a small expected-query set and is also covered by the fast suite.

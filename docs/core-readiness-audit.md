...
| Active skill library | Clean but small | Search is no longer polluted by fixtures and demos, and now includes merge, archive, and JSON-to-CSV dogfood samples. | Three real active skills still do not prove broad usefulness. |

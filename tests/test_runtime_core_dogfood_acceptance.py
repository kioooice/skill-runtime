...
class RuntimeCoreDogfoodAcceptanceTestsMixin:
    ...
    def test_global_auto_mode_stage_runner_supports_full_auto_finite_plan_mode(self) -> None:
        ...
        for phrase in [
            ...
            "不要停下来",
            "直到计划全部完成",
            "first present a longer finite plan for the user to inspect",
            "wait for explicit user approval after the plan is visible",
            ...
            "full-auto finite-plan mode begins with a plan-first checkpoint",
    ...
    def test_workflow_error_correction_keeps_agents_lightweight(self) -> None:
        ...
        for phrase in [
            ...
            "Full-auto collapse: when the user explicitly requests full-auto finite-plan mode, first show the longer plan",

...
class RuntimeDashboardTestsMixin:
    ...
    def test_global_dashboard_renderer_shows_project_operator_summary_statuses(self) -> None:
        ...
        self.assertIn("提供器状态：可用 / 新鲜", html)
        self.assertIn("基础检索状态：可用 / 过期", html)
        self.assertIn("工作流检索状态：不可用 / 未知", html)
    ...
    def test_dashboard_renderer_includes_core_sections(self) -> None:
        ...
        self.assertIn("可复用流程", html)
        self.assertIn("已审核并可直接复用的流程", html)
        ...
        self.assertIn("近期记录", html)
        self.assertIn('data-active-view="overview"', html)
    ...
    def test_dashboard_renderer_shows_operator_summary_overview_when_export_exists(self) -> None:
        ...
        self.assertIn("系统摘要", html)
        self.assertIn("data-operator-summary", html)
        self.assertIn("系统状态：新鲜", html)
        self.assertIn("基于稳定导出的只读摘要", html)
        self.assertIn("现有流程", html)
        self.assertIn("待审核候选", html)
        self.assertIn("任务轨迹", html)
        self.assertIn("建议操作", html)
        self.assertIn("提供器状态", html)
        self.assertIn("基础检索状态", html)
        self.assertIn("工作流检索状态", html)
        self.assertIn("Export operator summary", html)
        self.assertIn("非自动执行范围", html)
        self.assertIn("工作流检索状态", html)

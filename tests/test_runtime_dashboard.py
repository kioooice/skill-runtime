...
class RuntimeDashboardTestsMixin:
    ...
    def test_global_dashboard_renderer_includes_local_and_global_views(self) -> None:
        ...
        self.assertIn("跨项目运行状态总览", html)
        self.assertIn("现在先看什么", html)
        self.assertIn("跨项目情况", html)
        self.assertIn('data-view-target="overview"', html)
        self.assertIn('data-view-page="overview"', html)
        self.assertIn("可直接复用的流程", html)
        self.assertIn("最近发生了什么", html)
        self.assertIn("系统检查", html)
        self.assertIn("来源与范围", html)
    ...
    def test_global_dashboard_renderer_shows_project_operator_summary_statuses(self) -> None:
        ...
        self.assertIn("系统摘要：新鲜", html)
        self.assertIn("提供器质量：可用 / 新鲜", html)
        self.assertIn("基础技能检索：可用 / 过期", html)
        self.assertIn("工作流检索：不可用 / 未知", html)
    ...
    def test_dashboard_renderer_includes_core_sections(self) -> None:
        ...
        self.assertIn("可直接复用的流程", html)
        self.assertIn("已经审核通过、现在能直接复用的流程", html)
    ...
    def test_dashboard_renderer_shows_operator_summary_overview_when_export_exists(self) -> None:
        ...
        self.assertIn("系统当前状态", html)
        self.assertIn("data-operator-summary", html)
        self.assertIn("系统状态：新鲜", html)
        self.assertIn("这块只回答现在系统大概处在什么状态", html)
        self.assertIn("可直接复用的流程", html)
        self.assertIn("待审核流程", html)
        self.assertIn("已记录任务样本", html)
        self.assertIn("待你确认的建议", html)
        self.assertIn("提供器质量", html)
        self.assertIn("基础技能检索质量", html)
        self.assertIn("工作流检索质量", html)
        self.assertIn("Export operator summary", html)
        self.assertIn("这些动作不会自动执行", html)
        self.assertIn("工作流检索质量", html)
